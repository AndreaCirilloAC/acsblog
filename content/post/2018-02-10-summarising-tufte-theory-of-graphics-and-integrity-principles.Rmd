---
title: 'summarising Tufte: theory of graphics and integrity principles'
draft: false
author: Andrea Cirillo
date: '2018-02-10'
slug: summarising-tufte-theory-of-graphics-and-integrity-principles
categories:
  - analytics
  - dataviz
tags:
...
_number of entries in the data matrix behind a graph/ area of data display_
...
[Da vinci's Atlantic code image]

Images and words works together, producing an harmonious and effective result. What about shape?
...
*   if the graph suggests a shap by itself, follow the suggestion
...
[direttamente in R, settando il size]

The second plot results far more effective than the first one.
...
<img src="/images/lie_factor_wrong.jpg"  alt="lie_factor" style="width: 450px;"/>
</figure></a>

if we now compute the percentage variation of the phenomenon in reality we get: (15-10)/10 *100 = 50%

we then look at the percentage variation on the plot. To measure it we look at the real number of centimetres involved in the change from 10 to 15: (4.5cm - 1cm)/1cm *100 = 350%
...
<img src="/images/lie_factor_correct.jpg"  alt="proactive" style="width: 450px;"/>
</figure></a>
...
<img src="/images/ugly_bubble_chart.jpg"  alt="proactive" style="width: 450px;"/>
</figure></a>
...
<img src="/images/bubble_alternative.jpg"  alt="proactive" style="width: 450px;"/>
</figure></a>

### conclusions

I have practiced those principles for quite a long, and I can say they are really effective. They actually provide a safe guide while developing new plot or editing old ones.
